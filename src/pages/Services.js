        ...
        <div class="container">
            <div class="services-box">
                ...
                <div class="row justify-content-center">
                    ...
                    <div class="col-md-4 text-center mb-4">
                        <div class="crd">
                        <img src={require("../assets/images/2.jpg")} className="img-fluid mb-2" />
                    ...
                    <div class="col-md-4 text-center mb-4">
                        <div class="crd">
                        <img src={require("../assets/images/3.jpg")} className="img-fluid mb-2" />
                            <h5>Social Soirees and Parties</h5>
                    ...
                    <div class="col-md-4 text-center">
                        <div class="crd">
                        <img src={require("../assets/images/6.jpg")} className="img-fluid mb-2" />
